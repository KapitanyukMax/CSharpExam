...
namespace DataAccess.Migrations
{
    ...
    [Migration("20230619211437_CreateDatabase")]
            ...
            modelBuilder.Entity("ChatUser", b =>
                {
                    ...
                    b.Property<int>("UsersCredentialsId")
                        .HasColumnType("int");

                    b.HasKey("ChatsId", "UsersCredentialsId");

                    b.HasIndex("UsersCredentialsId");
            ...
            modelBuilder.Entity("ChatUser", b =>
                {
                    ...
                    b.HasOne("DataAccess.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UsersCredentialsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
